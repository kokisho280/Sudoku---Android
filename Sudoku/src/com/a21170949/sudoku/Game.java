...
public class Game extends Activity {
   ...
   private int puzzle[];
   private int aux_puzz[] = new int [9 * 9];
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      aux_puzz = getPuzzle(diff);
      
      // se a actividade recomeça, continua desde a ultima alteraçao
   ...
   /** cria o puzzle com a dificuldade escolhida **/
